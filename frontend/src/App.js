...
const stripePromise = loadStripe(
  "pk_test_51I5SwjCkP1aIaUis7r9xPfgttfwYd9Dbz6joX9VcgV4KX1PnxFofxQS0Z1vSHZ1Q4UMUqO5ZIVBMiNYLFuILznKd00ElOrsevC"
);
        ...
        <div className="app container-fluid d-flex flex-column justify-content-start min-vh-100">
          <header className="header justify-content-between w-100">
            <nav className="navbar navbar-expand-lg navbar-light row align-items-start">
              <a className="navbar-brand col-3 text-left" href="/">
                <img className="logo" src="/photos-site/logo2.png" />
              </a>
              <button
              ...
              <div
                className="collapse navbar-collapse col-9 p-0 ml-auto mt-2"
                id="navbarNav"
              >
                <ul className="navbar-nav col-md-12 d-flex justify-content-around align-items-start">
                  ...
                  <li className="nav-item d-flex align-items-center col-md-1 col-3 ml-auto p-0">
                    <div
                      className="cart p-0 d-flex flex-column align-items-center "
                      onClick={(e) => setIsVisible(!isVisible)}
                    >
                      <div className="div-icon-cart">
                        <FiShoppingCart size={22} />
                      </div>
                      <span className="numbitemscart">{numbItemsCart()}</span>
                    </div>
                  </li>
                  {userInfo ? (
          ...
          <div className="page-content d-flex justify-content-center align-items-start">
            ...
            <Route
              path="/modeles/:page?/:style?/:size?/:max?/:min?"
              component={Modeles_Page}
            />
            <Route
              path="/modele/:slug/:person/:face/:id"
              component={Modele_Page}
            />
          ...
          <footer
            id="footer"
            className="mt-auto d-flex align-items-center justify-content-around"
          >
            <ul>
              <li>Lorem ipsum</li>
              <li>Lorem ipsum</li>
